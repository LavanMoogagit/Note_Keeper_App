...
class DatabaseHelper {
  ...
  Future<List<Map<String, dynamic>>> getNoteMapList() async {
    ...
    // var result = await db.rawQuery('SELECT * FROM $noteTable order by $colPriority ASC'); both are same
  ...
  //Update Opearion: Update a note object and save it to database
  ...
  Future<int> deletetNote(int id) async {
    // debugPrint('deleting note with $id');
    Database db = await this.database;
    int result =
